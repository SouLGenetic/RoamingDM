...
/*
    ...
    Author: Bryan "Tonic" Boardwine (thanks to tonic for this one)
    Description:
    Output information received to admin menu.
*/
private ["_ret","_unit","_prim","_sec","_vest","_uni","_bp","_attach","_steamName","_secondary","_cPos"];
_ret = _this;
...
CONTROL(2900,2903) ctrlSetStructuredText parseText format ["<t size='1'>Name: %1<br/>Steam Name: %10<br/>Player UID: %11<br/>Player Side: %12<br/>Bank: %2<br/>Money: %3<br/>Uniform: %4<br/>Vest: %5<br/>Backpack: %6<br/>Primary: %7<br/>Handgun: %8<br/><t align='center'>Primary Attachments</t><br/>%9<br/><t align='center'>Secondary Attachments</t><br/>%13<br/></t>",_unit getVariable ["realname",name _unit],[(_ret select 0)] call life_fnc_numberText,[(_ret select 1)] call life_fnc_numberText, _uni,_vest,_bp,_prim,_sec,_attach,_steamName,(_ret select 5),(_ret select 6),_secondary];
_cPos = ctrlPosition CONTROL(2900,2903);
_cPos set [3,(ctrltextheight CONTROL(2900,2903)) max (0.275 * safezoneH)];
CONTROL(2900,2903) ctrlSetPosition _cPos;
CONTROL(2900,2903) ctrlcommit 0;