...
/*
    ...
    Author: Bryan "Tonic" Boardwine (edited by genetic)
    Description:
...
for "_i" from 0 to 1 step 0 do {
    ...
    _abortButton = CONTROL(49,104);
    _abortButton buttonSetAction "[] call SOCK_fnc_updateRequest; [player] remoteExec [""SS_fnc_Cleanup"",2];";
    ...
    _saveButton ctrlSetText "";
        ...
        _topButton ctrlSetText "RoamingDM";
