#define SYSTEM_TAG "rDM"
#define ITEM_TAG format ["%1%2",SYSTEM_TAG,"item_"]
#define CASH rDM_cash
#define BANK rDM_atmbank
...
#define EXTDB_FAILED(MESSAGE) \
    rDM_server_extDB_notLoaded = [true,##MESSAGE]; \
...
#define ITEM_VARNAME(varName) format ["rDM_inv_%1",M_CONFIG(getText,"VirtualItems",varName,"variable")]
...
#define rDM_SETTINGS(TYPE,SETTING) TYPE(missionConfigFile >> "rDM_Settings" >> SETTING)
