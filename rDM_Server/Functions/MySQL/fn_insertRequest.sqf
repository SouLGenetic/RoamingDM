...
_query = format ["SELECT Steam64, name FROM players WHERE Steam64='%1'",_uid];
...
_query = format ["INSERT INTO players (Steam64, name, CASH, BANK, aliases, Player_gear) VALUES('%1', '%2', '%3', '%4', '%5','""[]""')",
    _uid,
    _name,
    _money,
    _bank,
